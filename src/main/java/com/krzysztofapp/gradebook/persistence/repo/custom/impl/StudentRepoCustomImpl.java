...
public class StudentRepoCustomImpl implements StudentRepoCustom {
    ...
    public List<StudentEntity> findAllByGradeFAtCertainDay(LocalDate day) {
        ...
        List<StudentEntity> result = em.createQuery("SELECT s FROM StudentEntity s JOIN s.gradeList gl WHERE gl.gradeType = :F AND gl.dateOfGrade = :day")
    ...
    public List<StudentEntity> findAllByCertainGradeAtCertainDay(GradeType grade, LocalDate day) {
        ...
        List<StudentEntity> result = em.createQuery("SELECT s FROM StudentEntity s JOIN s.gradeList gl WHERE gl.gradeType = :grade AND gl.dateOfGrade = :day")
